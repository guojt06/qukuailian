...
describe("Local Test LocalAuction", async function () {
    ...
    beforeEach(async function () {
        ...
        // 2.部署拍卖合约
        const LocalAuction = await ethers.getContractFactory("OptimizedAuction");
        ...
        console.log("MultiTokenAuction deployed to:", auctionProxy.target);
        const proxyAddress = await auctionProxy.getAddress();
        console.log("MultiTokenAuction 代理合约地址：", proxyAddress);
        const implAddress = await upgrades.erc1967.getImplementationAddress(proxyAddress);
        console.log("MultiTokenAuction 实现合约地址：", implAddress);
