 ...
 */
contract LocalAuctionFactory is
    Initializable,
    UUPSUpgradeable,
    OwnableUpgradeable
{
    ...
    function createAuction(
        ...
        require(_usdcAddress != address(0), "nftContract not be 0x0");
        ...
        LocalAuction(payable(auctionAddress)).initialize(
            _usdcAddress,
            msg.sender,
            _nftContract,
            _duration,
